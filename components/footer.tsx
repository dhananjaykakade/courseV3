...
<img src="/favicon.png" alt="Trinity Courses Logo" className="w-8 h-8 mr-2" />   
            ...
            <p className="text-black-400 mb-4">
              Empowering learners worldwide with high-quality, accessible education. Master new skills and advance your
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <span className="text-xs text-black-400">100% Secure Payments powered by Razorpay</span>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-black-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Trinity Courses. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
